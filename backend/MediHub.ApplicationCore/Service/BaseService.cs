...
namespace MediHub.ApplicationCore.Service
{
    /// <summary>
    /// Baser service 
    /// </summary>
    ...
    public class BaseService<Generic> : IBaseService<Generic> where Generic : BaseEntity
    {
        ...
        public BaseService(IBaseRepository<Generic> baseRepository)
        {
            ...
            _serviceResult = new ServiceResult() { BaseCode = BaseEnum.Success };
        ...
        public ServiceResult Update(Guid id, Generic data)
        {
            try
            {
                ...
                {
                    _serviceResult.BaseCode = BaseEnum.NotValid;
                }
        ...
        public ServiceResult DeleteById(Guid id)
        {
            try
            {
                ...
                {
                    _serviceResult.BaseCode = BaseEnum.Success;
        ...
        private bool Validate(Generic data)
        {
            ...
            try
            {
                ...
                _serviceResult.BaseCode = BaseEnum.IsValid;
                _serviceResult.Data = messArr;
        ...
        private bool ValidateImport(Generic generic, IEnumerable<Generic> dataGetAll = null, IDictionary<object, List<string>> checkedProp = null)
        {
            try
            {
                ...
                {
                    temp.BaseCode = BaseEnum.IsValid;
                    temp.Data = isValid1;
                }
                else
                {
                    temp.BaseCode = BaseEnum.NotValid;
                    temp.Data = isValid1;
                }
        ...
        private string getValueSortedList(SortedList item, string prop)
        {
            try
            {
                ...
                foreach (var obj in item)
                {
                    ...
                    {
                        if (!string.IsNullOrEmpty(obj.GetType().GetProperty("Value").GetValue(obj).ToString()))
                        {
        ...
        public ServiceResult MutilpleInsert(string CacheKey)
        {
            try
            {
                ...
                if (resValue != null)
                {
                    ...
                    {
                        if (generic.ImportResult.BaseCode == BaseEnum.IsValid)
                        {
                            ...
                            if (serviceResult.BaseCode == BaseEnum.Success || serviceResult.BaseCode == BaseEnum.IsValid)
                            {
                                count++;
                            }
                        }
                ...
                else
                {
                    ...
                    serviceResult.BaseCode = BaseEnum.NotValid;
