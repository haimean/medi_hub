...
namespace MediHub.Infastructure
{
    /// <summary>
        ...
        public ServiceResult Insert(Generic data)
        {
            ...
            using (var transaction = _dbConnection.BeginTransaction())
            {
                try
                {
                    ...
                    serviceResult.BaseCode = BaseEnum.IsValid;
                    serviceResult.Messenger = Properties.Resources.AddSuccess;
        ...
        public ServiceResult Update(Guid id, Generic data)
        {
            ...
            using (var transaction = _dbConnection.BeginTransaction())
            {
                try
                {
                    ...
                    serviceResult.Data = rowAffects;
                    serviceResult.BaseCode = BaseEnum.IsValid;
                    serviceResult.Messenger = Properties.Resources.EditSuccess;
                ...
                catch (Exception ce)
                {
                    ...
                    serviceResult.BaseCode = BaseEnum.NotValid;
                    serviceResult.Messenger = Properties.Resources.EditError;
...
#pragma warning restore CS0693 // Type parameter has the same name as the type parameter from outer type
        ...
        public ServiceResult ImportData(Generic[] data)
        {
            ...
            using (var transaction = _dbConnection.BeginTransaction())
            {
                ...
                {
                    serviceResult.Data = rowAffects;
                    serviceResult.BaseCode = BaseEnum.Success;
        ...
        public ServiceResult MutilpleInsert(List<Generic> generics)
        {
            ...
            try
            {
                foreach (Generic generic in generics)
                {
                    ...
                    if (res.BaseCode == BaseEnum.IsValid)
                    {
                        count++;
                    }
                }
